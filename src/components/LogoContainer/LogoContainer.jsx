...
const LogoContainer = () => {
    ...
    return (
        <div className=" w-screen h-20 flex justify-between items-center px-6 mb-4">
            ...
            {/* Login button */}
            <BiSolidLogIn className={ theme?' text-3xl cursor-pointer  hover:text-orange-700 transition-all':' text-3xl cursor-pointer  hover:text-orange-700 transition-all text-white'}  ></BiSolidLogIn>
        </div>
    );
};
